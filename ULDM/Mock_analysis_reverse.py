...
kwargs_uldm = {'kappa_0': 0.09, 'theta_c': 3.2, 'theta_E': 1.4, 'gamma': 1.98, 'center_xULDM': 0.0, 'center_yULDM': 0.0, 'center_x': 0.0, 'center_y': 0.0, 'e1': 0.05, 'e2': 0.05}  # parameters of the deflector lens model

# the lens model is a superposition of an elliptical lens model with external shear
lens_model_list = ['ULDM-BAR', 'SHEAR']
kwargs_lens = [kwargs_uldm, kwargs_shear]
...
kwargs_lower_cosmo = {'h0': 0}
kwargs_upper_cosmo = {'h0': 150}
...
if run_sim == True:
    ...
    fitting_kwargs_list = [['PSO', {'sigma_scale': 1., 'n_particles': 200, 'n_iterations': 200}],
            ['MCMC', {'n_burn': 500, 'n_run': 1500, 'walkerRatio': 10, 'sigma_scale': .2}]
    ]
