...
if run_sim == True:
    ...
    file_name = 'mock_results_uldm_PLFraction'+noH0priorFlag+'uldm2pl.pkl'
    filedata = open(file_name, 'wb')
    pickle.dump(kwargs_result, filedata)
    filedata.close()

    file_name = 'mock_results_uldm_chain_PLFraction'+noH0priorFlag+'uldm2pl.pkl'
    filedata = open(file_name, 'wb')
...
if make_cornerPlot == True:
    ...
    if reprocess_corner == True:
        for i in range(len(samples_mcmc)):
            ...
            mcmc_new_list.append([gamma, theta_E, h0])

        file_name = 'mock_corner_PLFraction'+noH0priorFlag+'uldm2pl.h5'
        try:
